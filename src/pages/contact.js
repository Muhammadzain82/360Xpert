  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://api.360xpertsolutions.com/api/contact-uses",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      console.log(result);
      console.log(formData);
      toast.success("success"); // Use toast.success to display a success message
      ...
      toast.error("failed to send"); // Use toast.error to display an error message
    }
  };
