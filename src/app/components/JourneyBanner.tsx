  ...
  return (
    <div className="w-full flex justify-center py-6 md:py-10">
      <div className="p-4 sm:p-8 md:p-12 relative overflow-hidden mx-auto w-full max-w-3xl md:max-w-5xl h-auto md:h-[400px]">
        <div
          className="bg-gradient-to-t from-[#333333] to-[#222222] rounded-lg p-4 sm:p-6 md:p-10 flex flex-col md:flex-row justify-between items-center h-full w-full"
          data-aos="fade-up"
        >
          <div
            className="max-w-full md:max-w-2xl ml-0 md:ml-10 text-center md:text-left"
            data-aos="fade-right"
            data-aos-delay="100"
          >
          ...
          <div
            className="flex flex-col items-center md:items-end mt-6 md:mt-0 mr-0 md:mr-10"
            data-aos="fade-left"
            data-aos-delay="300"
          >
            <Image
