...
//             <form
//               onSubmit={handleSubmit}
//               className="flex flex-col gap-5 text-sm font-clash"
//             >
//               {/* Looking For? */}
//               <label htmlFor="field" className="font-bold text-lg">
//                 Looking For?
//               </label>
//               <select
//                 id="field"
...
//               {/* Company and Message */}
//               <label htmlFor="company" className="font-bold text-lg">
//                 Company
//               </label>
//               <input
//                 type="text"
...
//                 type="submit"
//                 onClick={submit}
//                 className="mt-5 bg-red-600 text-white font-semibold py-3 px-6 rounded-full hover:bg-white hover:text-red-600 border border-red-600 transition-all"
//               >
//                 Get started
//               </button>
//             </form>
