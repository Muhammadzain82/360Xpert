...
const jobs = [
  {
    title: "Software Engineer",
    description: "We are looking for a mid-level Software Engineer to join our team.",
  },
  {
    title: "Backend Developer",
    description: "We are looking for a mid-level Backend Developer to join our team.",
  },
  {
    title: "UI/UX Designer",
  ...
  {
    title: "Full Stack Developer",
    description: "We are looking for a mid-level Full Stack Developer to join our team.",
  },
  {
    title: "Project Manager",
    description: "We are looking for a mid-level Project Manager to join our team.",
  },
]
...
export default function JobListings() {
  ...
  return (
    <div className="relative bg-[#181815] text-white overflow-hidden px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
      <div className="absolute inset-0 z-0 w-full h-full bg-cover bg-center opacity-50">
        <Image
          src="/right.png"
          alt="Wave background"
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-6 sm:space-y-8 lg:space-y-10">
        {jobs.map((job, index) => (
          <div
            key={index}
            className="border-b border-gray-700 pb-4 sm:pb-6 lg:pb-8 relative"
            onMouseEnter={() => setHoveredIndex(index)}
            onMouseLeave={() => setHoveredIndex(null)}
          >
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
              <div className="w-full sm:w-3/4">
                <h2 className="font-['Clash_Display'] font-medium text-xl sm:text-2xl lg:text-3xl mb-2 sm:mb-1">
                  {job.title}
                </h2>
                <p className="text-sm lg:text-base text-gray-400 mb-3 sm:mb-2 font-['Clash_Display']">
                  {job.description}
                </p>
                <div className="space-x-2 mb-4 sm:mb-0">
                  <span className="bg-red-900 text-white px-2 sm:px-3 py-1 rounded-sm text-xs lg:text-sm font-['Clash_Display']">
                    Full Time
                  </span>
                  <span className="bg-red-900 text-white px-2 sm:px-3 py-1 rounded-sm text-xs lg:text-sm font-['Clash_Display']">
                    On Site
              ...
              <button 
                onClick={() => router.push('/CareersForm')}  
                className="text-white relative z-[10000] bg-red-900 px-3 py-2 flex items-center mt-4 sm:mt-0 font-['Clash_Display'] font-medium text-base sm:text-lg lg:text-xl transition-colors hover:bg-red-800"
              >
                Apply
                <Image
                  src="/arrow-right.png"
            ...
            <div
              className={`absolute inset-0 flex items-center justify-center transition-opacity duration-300 pointer-events-none ${
                hoveredIndex === index ? "opacity-10 sm:opacity-20" : "opacity-0"
              }`}
            >
              <Image
                src="/coding.png"
